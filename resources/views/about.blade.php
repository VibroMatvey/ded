...
@section('about')
    <div class="page">
        <div class="about__page">
            <div class="about__page_title">
                Строительный дед - это про надежность!
            </div>
            <div class="about__page_card">
                <div class="about__page_card_content">
                    <div class="about__page_card_item">
                        <div class="card__icon">
                            <i class="fa-solid fa-box"></i>
                        </div>
                        <div class="card__title">
                            <span>Качественная упаковка!</span>
                        </div>
                    </div>
                    <div class="about__page_card_item">
                        <div class="card__icon">
                    ...
                    <div class="about__page_card_item">
                        ...
                        <div class="card__title">
                            <span>Выбирайте строительного деда!</span>
                        </div>
                    </div>
                </div>
            </div>
